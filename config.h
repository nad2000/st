 ...
 */
unsigned int defaultfg = 7; //257;        // 7;
unsigned int defaultbg = 0; //256;        // 0;
unsigned int defaultcs = 258; // 256;
static unsigned int defaultrcs = 257; //256;
